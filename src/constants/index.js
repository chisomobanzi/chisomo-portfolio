...
export const projects = [
  {
    ...
    keyFigures: [
      { name: 'Frank E. Flowers', role: 'Director', link:'https://www.imdb.com/name/nm1248193/' },
      { name: 'Philip Ivey', role: 'Production Designer', link:'https://www.imdb.com/name/nm1134464/' },
      { name: 'Charlie Revai', role: 'Supervising Art Director', link:'https://www.imdb.com/name/nm0720748/' },
    ],
    gallery: [
      { src: '/projects/the-bluff/gallery-01.mp4', caption: 'Gallery video 1', group: 'Cave Set' },
      { src: '/projects/the-bluff/gallery-02.png', caption: 'Gallery image 2', group: 'Cave Set' },
      { src: '/projects/the-bluff/gallery-03.mp4', caption: 'Gallery video 3', group: 'Cave Set' },
      { src: '/projects/the-bluff/gallery-04.jpg', caption: 'Gallery image 4', group: 'Cave Set' },
      { src: '/projects/the-bluff/gallery-05.jpg', caption: 'Gallery image 5', group: 'Cave Set' },
      { src: '/projects/the-bluff/gallery-06.mp4', caption: 'Gallery video 6', group: 'Cave Set' },
      { src: '/projects/the-bluff/gallery-07.mp4', caption: 'Gallery video 7', group: 'Bodden House' },
      { src: '/projects/the-bluff/gallery-08.jpg', caption: 'Gallery image 8', group: 'Bodden House' },
      { src: '/projects/the-bluff/gallery-09.jpg', caption: 'Gallery image 9', group: 'Bodden House' },
      { src: '/projects/the-bluff/gallery-10.mp4', caption: 'Gallery video 10', group: 'Severence Ship' },
      { src: '/projects/the-bluff/gallery-11.png', caption: 'Gallery image 11', group: 'Severence Ship' },
      { src: '/projects/the-bluff/gallery-12.jpg', caption: 'Gallery image 12', group: 'Severence Ship' },
    ],
  },
  {
    id: 'nautilus',
    ...
    keyFigures: [
      { name: 'David Lee', role: 'Production Designer', link:'https://www.imdb.com/name/nm0497117/' },
      { name: 'Brian Edmonds', role: 'Supervising Art Director', link:'https://www.imdb.com/name/nm0249481/' },
    ],
    gallery: [
      { src: '/projects/nautilus/gallery-01.mp4', caption: 'Gallery video 1', group: 'Nautilus Ship - Engine Room (Props)' },
      { src: '/projects/nautilus/gallery-02.jpg', caption: 'Gallery image 2', group: 'Nautilus Ship - Engine Room (Props)' },
      { src: '/projects/nautilus/gallery-03.jpg', caption: 'Gallery image 3', group: 'Nautilus Ship - Engine Room (Props)' },
      { src: '/projects/nautilus/gallery-04.mp4', caption: 'Gallery image 4', group: 'Dreadnought Forge' },
      { src: '/projects/nautilus/gallery-05.jpg', caption: 'Gallery image 5', group: 'Dreadnought Forge' },
      { src: '/projects/nautilus/gallery-06.jpg', caption: 'Gallery image 6', group: 'Dreadnought Forge' },
      { src: '/projects/nautilus/gallery-07.mp4', caption: 'Gallery image 7', group: 'Rajah Ice Machine' },
      { src: '/projects/nautilus/gallery-08.jpg', caption: 'Gallery image 8', group: 'Rajah Ice Machine' },
      { src: '/projects/nautilus/gallery-09.jpg', caption: 'Gallery image 9', group: 'Rajah Ice Machine' },
    ],
  },
  {
    id: 'monarch-s2',
    ...
    keyFigures: [
      { name: 'Caroline Hanania', role: 'Production Designer', link: 'https://www.imdb.com/name/nm0359268/'},
      { name: 'Simon McCutcheon', role: 'Supervising Art Director', link: 'https://www.imdb.com/name/nm0567361/' },
    ],
    gallery: [
      ...
      { src: '/projects/monarch-s2/gallery-03.jpeg', caption: 'Gallery image 3' },
      ...
      // { src: '/projects/monarch-s2/gallery-07.jpg', caption: 'Gallery image 7' },
      // { src: '/projects/monarch-s2/gallery-08.jpg', caption: 'Gallery image 8' },
      // { src: '/projects/monarch-s2/gallery-09.jpg', caption: 'Gallery image 9' },
    ],
  },
  {
    id: 'constellations',
  ...
  // },
  {
    ...
    keyFigures: [
      { name: 'Sam Esmail', role: 'Director', link:'https://www.imdb.com/name/nm1322753/' },
      { name: 'Sophie Becher', role: 'Production Designer', link:'https://www.imdb.com/name/nm0064984/' },
      { name: 'Mark Robins', role: 'Supervising Art Director', link:'https://www.imdb.com/name/nm0732314/' },
    ],
    gallery: [],
  },
