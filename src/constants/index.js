...
export const projects = [
  {
    ...
    gallery: [
      { src: '/projects/the-bluff/gallery-01.jpg', caption: 'Building the physical scale model', group: 'Cave Set' },
      { src: '/projects/the-bluff/gallery-02.jpg', caption: '3D scanning for digital capture', group: 'Cave Set' },
      { src: '/projects/the-bluff/gallery-03.png', caption: 'Cave system in Unreal Engine', group: 'Cave Set' },
      { src: '/projects/the-bluff/gallery-04.mp4', caption: 'Director Frank E. Flowers in VR previs', group: 'Cave Set' },
      { src: '/projects/the-bluff/gallery-05.mp4', caption: 'First-person view inside the VR cave', group: 'Cave Set' },
      { src: '/projects/the-bluff/gallery-06.mp4', caption: 'The finished cave on screen', group: 'Cave Set' },
      { src: '/projects/the-bluff/gallery-07.mp4', caption: 'Bodden House on set, Gold Coast', group: 'Bodden House' },
      { src: '/projects/the-bluff/gallery-08.jpg', caption: 'Construction section drawing', group: 'Bodden House' },
      { src: '/projects/the-bluff/gallery-09.jpg', caption: 'On location with the finished build', group: 'Bodden House' },
    ],
  },
  {
    id: 'nautilus',
